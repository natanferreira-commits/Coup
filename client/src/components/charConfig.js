...
export const CHAR_CONFIG = {
  ...
  assassino:     { label: 'Miliciano', color: '#b71c1c', icon: '🔪', desc: 'Elimina carta (3 moedas)',        img: milicianoImg },
  guarda_costas: { label: 'Segurança', color: '#4e342e', icon: '🛡️', desc: 'Bloqueia Miliciano e Bicheiro',  img: null         },
};
